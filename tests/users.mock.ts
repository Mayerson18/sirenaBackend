...
export const castError = new Error('Cast to number failed for value "NaN" at path "id" for model "Users"');
...
export const createError = new Error('E11000 duplicate key error collection: study1.users index: id_1 dup key: { id: 30247892 }');
